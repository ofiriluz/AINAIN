...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "russia.py"

        #Name of program
        self.project_name = "russia"
        ...
        self.license = "Russia License"

        #Auhor of program
        self.author_name = "Me"
        self.author_email = "russia@russia.com"
        self.copyright = "Copyright (c) 2018 Me."

        #Description
        self.project_description = "Russia Description"
